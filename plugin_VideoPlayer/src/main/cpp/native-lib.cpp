...
JNIEXPORT jint JNICALL
Java_com_sn_videoplayer_ffmpeg_demo_DemoNativeInterface_initMedia(JNIEnv *env,
                                                                  jobject obj/* this */,
                                                                  jstring path) {
...
Java_com_sn_videoplayer_ffmpeg_demo_DemoNativeInterface_videoInfo(JNIEnv *env, jobject thiz,
    ...
    AVCodecContext *pCodecCtx = avcodec_alloc_context3(
        ...
        if (packet.stream_index == videoindex) {
            ...
            if (frameFinished == 0) {
                ...
                if (pFrame->pict_type == AV_PICTURE_TYPE_I) {
                    ...
                    //把yuv数据保存为png图片
                    sprintf(filename,
                            "/storage/emulated/0/Android/data/com.sn.videoplayer/files/PNG/frame%d.png",
                            i);
